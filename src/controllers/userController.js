...
class UserController {
	...
	async put(req, res){
		...
		if(data.nickname) validationContract.hasMinLen(data.nickname, 3, "O apelido deve conter pelo menos 3 caracteres.");
		if(data.nickname) validationContract.hasMaxLen(data.nickname, 30, "O apelido deve conter no máximo 30 caracteres.");
		if(data.nickname) validationContract.haveSpaces(data.nickname, "O apelido não pode conter espaços.");
